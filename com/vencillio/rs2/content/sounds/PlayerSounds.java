package com.vencillio.rs2.content.sounds;
...
public class PlayerSounds {
	...
	public static void sendBlockOrHitSound(Player player, boolean hit) {
		...
		if ((shield != null) && (sounds[shield.getId()] != null)) {
			player.getClient().queueOutgoingPacket(new SendSound(sounds[shield.getId()][com.vencillio.core.util.Utility.randomNumber(sounds[shield.getId()].length)].id, 0, 0));
		}
